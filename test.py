...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Wake word
        if not active:
            if "hi jarvis" in query or "hello jarvis" in query or "hey jarvis" in query or "wake up jarvis" in query or "wake up" in query or "hi" in query or "hello" in query or "HEY" in query or "daddy's home" in query or "wake up daddy's home" in query:
                active = True
